...
@section("content")
  <div class="row">
    ...
    <div class="col s10 login text-center align-middle" style="text-align: center">
      <p>Welcome</p>
      <p>To</p>
      <h1 style="font-weight:bold; font-family:Arial, Helvetica, sans-serif; color:yellow">
        HoneyWeb.Org
      </h1>
      <p style="font-weight:bold; font-family:Arial, Helvetica, sans-serif; color:pink; letter-spacing: 4px;">Delightful Web Creations</p>
...
<g>
  ...
  <path d="M278.509,256.531c-0.151-1.914-1.071-3.685-2.549-4.909l-57.861-47.961c5.862-13.987,19.581-53.331,4.714-86.19   L174.593,4.323c-1.323-3.107-4.651-4.857-7.96-4.177c-3.309,0.675-5.685,3.586-5.685,6.963c0,8.016,0.072,160.292,0.092,203.485   l0.004,10.139c0.001,1.477,0.461,2.917,1.319,4.121l60.574,85.014c1.26,1.768,3.259,2.864,5.428,2.974   c0.121,0.006,0.241,0.009,0.36,0.009c2.04,0,3.988-0.877,5.341-2.419l42.698-48.649   C278.032,260.338,278.661,258.445,278.509,256.531z" style="fill: wheat;"></path>
      ...
      <a class="waves-effect waves-light btn blue darken-2" href="{{route('c.auth.signup')}}">Get Started</a><br><br>
      <form method="post" action="{{route("theme")}}">
        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
        <input type="hidden" name="uuid" id="uuid" value="fds"/>
        <input type="submit" class="waves-effect waves-light btn blue darken-2" name="theme" value="Bootstrap Theme" onclick="uuid()">
        <input type="submit" class="waves-effect waves-light btn blue darken-2" name="theme" value="Materialize Theme" onclick="uuid()">
      </form>
    </div>
  </div>
