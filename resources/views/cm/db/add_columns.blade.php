...
<div class="row">
  ...
  <div class="col s12 m8">
		...
		<button type="submit" class="waves-effect waves-light btn blue darken-2">Update Table</button><a class="waves-effect waves-light btn blue darken-2" href="{{route('c.my.table.list')}}">Back</a></div>
  </div>
</div>
	<div class="row">
		<div class="col s12">
