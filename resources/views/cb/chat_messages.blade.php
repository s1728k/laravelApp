...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12 table-responsive">
			<table class="table">
        <caption>Chat Messages | for the app id: {{\Auth::user()->active_app_id}}<div class="btn-group" style="float:right"> <a class="btn btn-default" href="{{ route('c.chat.requests') }}">Chat Requests</a><a class="btn btn-default" href="{{ route('c.chat.can_chat_with') }}">Chat Settings</a><a class="btn btn-default" href="{{ route('c.chat.ccac.view') }}">Customer Care App Configuration</a></div></caption>
				<thead>
					<tr>
						<th>Sr</th>
            <th>message</th>
