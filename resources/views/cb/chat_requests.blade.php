...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12 table-responsive">
      <table class="table">
        <caption>Can Requests | for the app id: {{\Auth::user()->active_app_id}}<div class="btn-group" style="float:right"> <a class="btn btn-default" href="{{route('c.chat.messages')}}">Back</a></div></caption>
        <thead>
          <tr>
            <th>Sr</th>
            <th>fid</th>
