...
<div class="container-fluid">
    ...
    <div class="col-md-4"></div>
		<div class="col-md-4 table-responsive">
			<table class="table">
        <caption>Customer Care App Configuration Table |  for the app id: {{\Auth::user()->active_app_id}}
          <div class="btn-group" style="float:right"> <a class="btn btn-default" href="{{route('c.chat.messages')}}">Back</a></div></caption>
        <thead>
          <tr>
            <th>Api Call Name</th>
            <th></th>
