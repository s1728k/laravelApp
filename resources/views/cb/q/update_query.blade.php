...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 text-center">
			<caption class="">Update Query	<div class="input-group" style="float:right;">
					...
					<div class="col-md-6">
						...
						<div class="row">
							...
							@foreach($auth_providers as $auth_provider)
								<div class="checkbox" style="display: inline-flex; margin-right: 10px"><label><input type="checkbox" onchange="ap('{{$auth_provider}}')" @if(in_array($auth_provider, explode(', ', $query->auth_providers))) checked @endif >{{$auth_provider}}</label></div>
							@endforeach
							</div>
						</div>
					</div>			
					...
					<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="checkbox" style="display: inline-flex; margin-right: 10px"><label><input type="checkbox" onchange="c('{{$v}}')" @if(in_array($v, explode(', ', $query->commands))) checked @endif>{{$k}}</label></div>
								@endforeach
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="checkbox" style="display: inline-flex; margin-right: 10px"><label><input type="checkbox" onchange="s('{{$sp}}')" @if(in_array($sp, explode(',', $query->specials))) checked @endif>{{$sp}}</label></div>
								@endforeach
							</div>
						</div>
					</div>
